...
import './article'
import { recent } from './article';
import { science } from './article';
import { healths } from './article';
    ...
    return (
        <div>
            ...
            <div className="recentArticles">
                <h3>Recent Medical News</h3>
                <div className="row articles">
                    {recent.map((key) => {
                        return <Recent details={key} key={key.id} />
                    })}
                </div>
            </div>
            ...
            <div className="recentArticles">
                ...
                <div className="row articles">
                    {science.map((key) => {
                        return <Science details={key} key={key.id} />
                    })}
                </div>
            </div>
            ...
            <div className="recentArticles">
                ...
                <div className="row articles">
                    {healths.map((key) => {
                        return <Health details={key} key={key.id} />
                    })}
                </div>
            </div>
